...
class Tests {
    ...
    fun battleOutcomeForPuzzleInput() {
        assertEquals(189000, battleOutcome(World.parse(puzzleInput), 3))
    }
    ...
    fun runGameReturnsTurnsUntilCompletion() {
        ...
        assertEquals(2, runGame(world, 3))
    }
    ...
    fun runGame_example_rightNumberOfTurns() {
        ...
        assertEquals(47, runGame(world, 3))
    }
    ...
    fun runGame_anotherExample() {
        ...
        assertEquals(67, runGame(world, 3))
    }
    ...
    fun runGame_stillAnotherExample() {
        ...
        assertEquals(71, runGame(world, 3))
    }
    ...
    fun battleOutcome_example() {
        ...
        assertEquals(27730, battleOutcome(world, 3))
    }
    ...
    fun battleOutcome_anotherExample() {
        ...
        assertEquals(67 * 200, battleOutcome(world, 3))
    }
    ...
    fun battleOutcome_stillAnotherExample() {
        ...
        assertEquals(71 * 197, battleOutcome(world, 3))
    }
    ...
    fun battleOutcome_evenMoreExamples() {
        ...
        assertEquals(38 * 486, battleOutcome(world1, 3))
        ...
        assertEquals(66 * 202, battleOutcome(world2, 3))
    }
...
class WorldTests {
    ...
    @Test
    fun fightAppliesElfAttackPower() {
        val subject = World.parse("""
            ####
            #EG#
            ####
