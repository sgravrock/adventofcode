...
class day22_2_tests: XCTestCase {
	...
	func test_turns() {
		let player = Player(hitPoints: 12, mana: 250)
		...
		XCTAssertEqual(3, player.hitPoints)		// boss does 8 damage
	...
	func test_playerTurn_costs1HitPoint() {
	...
	func test_playerTurn_initialDamageCanKillPlayer() {
		let player = Player(hitPoints: 1, mana: 250)
		let boss = Boss(hitPoints: 13, damagePoints: 8)
		playerTurn(player: player, boss: boss, spell: magicMissile)
		XCTAssertEqual(0, player.hitPoints)
		XCTAssertEqual(13, boss.hitPoints) // spell was never cast, did no damage
	}
	
	func test_turns_secondExample() {
		let player = Player(hitPoints: 15, mana: 250)
		...
		*/
		XCTAssertEqual(14, player.hitPoints)
		XCTAssertEqual(14, boss.hitPoints)
		bossTurn(player: player, boss: boss)
		...
		*/
		XCTAssertEqual(6, player.hitPoints)
		XCTAssertEqual(14, boss.hitPoints)
		...
		*/
		XCTAssertEqual(5, player.hitPoints)
		XCTAssertEqual(14, boss.hitPoints)
		bossTurn(player: player, boss: boss)
		XCTAssertEqual(2, player.activeEffects.count)
		...
		*/
		XCTAssertEqual(4, player.hitPoints)
		XCTAssertEqual(14, boss.hitPoints)
