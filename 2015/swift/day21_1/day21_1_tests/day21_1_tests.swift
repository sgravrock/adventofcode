...
class day21_1_tests: XCTestCase {
	...
	func test_cheapestWin() {
		let w1 = Item(type: .Weapon, cost: 1, damage: 2, armor: 5)
		let w2 = Item(type: .Weapon, cost: 2, damage: 5, armor: 5)
		let r = Item(type: .Ring, cost: 3, damage: 3, armor: 0)
		let expected = 2 // w2
		let actual = cheapestWin(items: [w1, w2, r],
		                         playerHitPoints: 8,
		                         bossDamagePoints: 7,
		                         bossArmorPoints: 2,
		                         bossHitPoints: 12)
