...
std::deque<char> dance(std::deque<char> programs, std::vector<std::shared_ptr<Instruction>> instructions);
int period(std::deque<char> programs, std::vector<std::shared_ptr<Instruction>> instructions);
