const {maxRedistributions, sourceBankIx, redistributeBlocks, BankSet} = require('../lib.js');

describe('maxRedistributions', function() {
	it('solves [0, 2, 7, 0]', function() {
		expect(maxRedistributions([0, 2, 7, 0])).toEqual(5);
	});
});
