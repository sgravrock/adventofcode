...
110 GOSUB 1900
113 REM Assumes that some register will go positive.
114 REM Should be the minimim number value but I don't know what that is.
115 MAX = 0
...
150 GOSUB 1100
160 NEXT PC
190 PRINT "Largest register value seen is "; MAX
200 END
...
1250 IF RV(OUT) > MAX THEN MAX = RV(OUT)
1270 RETURN
