...
class day15_1_tests: XCTestCase {
    func test_bestCookieScore() {
        ...
        XCTAssertEqual(57600000, bestCookieScore(input: input))
    }
    ...
    func test_isValid() {
        ...
        let invalid = Recipe(amounts: [
            "Butterscotch": 44,
            "Cinnamon": 56
        ])
        XCTAssertFalse(isValid(recipe: invalid, ingredients: ingredients))
        let valid = Recipe(amounts: [
            "Butterscotch": 40,
            "Cinnamon": 60
        ])
        XCTAssertTrue(isValid(recipe: valid, ingredients: ingredients))
    }
    ...
    func test_parseInput() {
        ...
        XCTAssertEqual(8, result.attributes["calories"])
    }
